define([
  ...
  return declare([TabViewerBase], {
    ...
    onSetState: function (attr, oldVal, state) {
      ...
      DataAPI.query("genome", state.search, {
        select: ["genome_id", "bioproject_accession"],
      }).then(
        lang.hitch(this, (res) => {
    ...
    onSetQuery: function (attr, oldVal, newVal) {
      ...
      this.queryNode.innerHTML =
        '<span class="queryModel">Genomes: </span>  ' + content;
    },
    ...
    setActivePanelState: function () {
      var active =
        this.state && this.state.hashParams && this.state.hashParams.view_tab
